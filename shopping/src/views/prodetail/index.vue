  ...
  <div class="prodetail">
    ...
    <van-swipe :autoplay="3000" @change="onChange">
      <van-swipe-item v-for="(image, index) in images" :key="index">
        <img v-lazy="image?.external_url || image" class="swiper-image" />
      </van-swipe-item>
    ...
    <div class="comment">
      <div class="comment-title">
        <div class="left">商品评价{{ total > 0 ? ' (' + total + '条)' : '' }}</div>
        <div class="right" v-if="total > 0">查看更多 <van-icon name="arrow" /> </div>
      </div>
      <div v-if="total > 0" class="comment-list">
    ...
    <van-action-sheet v-model="showPannel" :title="mode === 'cart' ? '加入购物车' : '立刻购买'">
      ...
      <div class="left">
        <img :src="detail.goods_images?.[0]?.external_url || detail.goods_images?.[0] || defaultImg" alt="">
      </div>
      <div class="right">
        <div class="price">
          <span>¥</span>
